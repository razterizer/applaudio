...
| HRTF / 3D psychoacoustic cues | ⚙️ Can be emulated via DSP (reverb, filters) in 8Beat | 🚫 Not included | 🚫 None | 🚫 None | ✅ Built-in optional HRTF / advanced 3D | 🚫 None built-in; can emulate via custom DSP | 🚫 None built-in; can emulate via custom DSP |

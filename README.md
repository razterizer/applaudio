...
| Reverb / environmental effects | Yes, via 8Beat DSP (`reverb()`, `fast_reverb()`) | None (requires extension or manual DSP) | None | None | Yes, advanced | Minimal built-in; can be implemented via DSP | Built-in simple effects; DSP chain allows custom reverb |
